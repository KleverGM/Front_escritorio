      ...
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-6">
          <div className="flex flex-col items-center">
            ...
            {/* Badge de rol */}
            <span className={`px-4 py-1.5 rounded-full text-sm font-medium ${getRoleColor()} flex items-center gap-2`}>
        ...
        <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
          <h2 className="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
            <svg className="w-6 h-6 text-[#f8b31d]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="flex items-start gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors">
      ...
      <div className="flex-1 min-w-0">
        ...
        <dd className="text-base font-semibold text-gray-900 break-words">{value}</dd>
      </div>
    </div>
  );
}
