      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-800 mb-8">
          ...
          <div className="space-y-3">
            {cursosPopulares.slice(0, 5).map((curso, index) => (
              <div
                key={curso.id}
                className="flex items-center gap-4 p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition"
              >
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-800">
          ...
          <div className="space-y-3">
            {actividad.slice(0, 10).map((item, index) => (
              <div
                key={index}
                className="flex items-start gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-lg transition"
              >
                <div
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-blue-100 dark:bg-blue-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
                className="w-6 h-6 text-blue-600 dark:text-blue-300"
                fill="none"
                stroke="currentColor"
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-purple-100 dark:bg-purple-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
                className="w-6 h-6 text-purple-600 dark:text-purple-300"
                fill="none"
                stroke="currentColor"
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-green-100 dark:bg-green-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
                className="w-6 h-6 text-green-600 dark:text-green-300"
                fill="none"
                stroke="currentColor"
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-yellow-100 dark:bg-yellow-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
                className="w-6 h-6 text-yellow-600 dark:text-yellow-300"
                fill="none"
                stroke="currentColor"
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-red-100 dark:bg-red-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-indigo-100 dark:bg-indigo-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
          ...
          <Link
            ...
            className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 hover:shadow-md transition border border-gray-200 dark:border-gray-800 text-center"
          >
            <div className="w-12 h-12 bg-pink-100 dark:bg-pink-900/40 rounded-lg flex items-center justify-center mx-auto mb-2">
              <svg
