  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (errorData?.username) {
        setError(`Usuario: ${Array.isArray(errorData.username) ? errorData.username.join(', ') : errorData.username}`);
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-blue-800 mt-1">
              Actualiza tu información personal. El correo electrónico no se puede cambiar por seguridad.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-start gap-3">
              ...
              <p className="text-sm text-green-800">✓ Perfil actualizado exitosamente. Redirigiendo...</p>
            </div>
          )}
